      ...
      if (data?.length == 0) {
            return (
                  <div className='flex-center flex-col font-bold gap-3'>
                        <svg width="600" height="250" className='animate-pulse' viewBox="0 0 200 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect x="70" y="30" width="100" height="50" rx="8" fill="#E9ECEF" />
                              <rect x="40" y="60" width="100" height="50" rx="8" fill="#F8F9FA" />
                              <rect x="55" y="75" width="50" height="6" rx="3" fill="#CED4DA" />
                              <rect x="55" y="87" width="70" height="6" rx="3" fill="#CED4DA" />
                              <rect x="85" y="45" width="50" height="6" rx="3" fill="#DEE2E6" />
                              ...
                              <path d="M30 50h2v2h-2zM168 70h2v2h-2zM120 20h2v2h-2zM90 105h2v2h-2z" fill="#E9ECEF" />
                        </svg>
                        <div>No Videos</div>
                  </div>
            )
