...
const Page = () => {
      ...
      return (
            <div className='min-h-[100dvh] relative [--lns-color-primary:var(--primary)] overflow-hidden  space-y-12'>
                  <div className='absolute bg-gradient-to-bl from-[#b2b3f1] -right-[30%] to-violet-200/10 h-[34rem] -z-10 w-[66rem] blur-[50px]'></div>
