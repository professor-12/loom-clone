            ...
            <div className='[--h:60px] sticky top-0'>
                  <div className='h-[var(--h)] gap-4 flex justify-between items-center px-5  border-b absolute z-200 bg-white top-0 w-full'>
                        ...
                        <div className='flex items-center gap-4'>
                              <Button className='font-bold text-primary border-primary hover:bg-primary/20 hover:text-primary rounded-xl' variant={"outline"}>
                                    <p className='text-sm'>
                                          6/50 Videos
                                    </p>
                              ...
                              <Button className='font-bold rounded-xl'>Upgrade</Button>
