            ...
            <div className='w-full px-4 bg-light-foreground min-h-[100dvh] flex py-20 md:py-28 pb-20 gap-6 items-center justify-center flex-col'>
                  ...
                  <div className='flex items-center max-sm:flex-col pt-6 gap-5'>
                        <Link href={"/signup"}>
                              ...
                              <button className='text-lg hover:translate-1 duration-100 transition-transform cursor-pointer font-medium bg-[#565ADD] border-[5px] border-[#9FA1EC] p-4 text-white rounded-full'>Get Loop for free</button>
                        </Link>
                  ...
                  <div className='aspect-video relative overflow-hidden hover: w-full mx-auto md:w-[90%] lg:max-w-[85%] rounded-[3rem] bg-black'>
                        <div className=''></div>
                        <figure className='w-full hover:brightness-90 h-full'>
                              <video className='object-contain' loop autoPlay controls muted src="/hero.mp4"></video>
                        </figure>
                  </div>
            </div>
      )
